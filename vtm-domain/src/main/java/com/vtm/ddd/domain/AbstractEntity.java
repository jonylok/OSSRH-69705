...
public abstract class AbstractEntity extends BaseEntity {
     ...
     */
    public static <T extends com.vtm.ddd.domain.Entity> T get(Class<T> clazz, Serializable id) {
     ...
     * @return 实体的未修改版本。
     */
    public static <T extends com.vtm.ddd.domain.Entity> T getUnmodified(Class<T> clazz, T entity) {
     ...
     * @return 类型为T或T的子类型，ID为id的实体。
     */
    public static <T extends com.vtm.ddd.domain.Entity> T load(Class<T> clazz, Serializable id) {
     ...
     * @return 符合条件的实体列表
     */
    public static <T extends com.vtm.ddd.domain.Entity> List<T> findAll(Class<T> clazz) {
     ...
     * @return 符合条件的实体列表
     */
    public static <T extends com.vtm.ddd.domain.Entity> List<T> findByProperty(Class<T> clazz, String propName, Object value) {
     ...
     * @return 符合条件的实体列表
     */
    public static <T extends com.vtm.ddd.domain.Entity> List<T> findByProperties(Class<T> clazz, Map<String, Object> propValues) {
